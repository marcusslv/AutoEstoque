...
use App\Modules\Identity\Infrastructure\Persistence\Eloquent\EloquentAccessTokenRevoker;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(AccessTokenRevoker::class, EloquentAccessTokenRevoker::class);
        ...
        $this->app->bind(ServiceOrderListQuery::class, EloquentServiceOrderListQuery::class);
